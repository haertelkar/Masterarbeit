...
def zernikeTransformation(pathToZernikeFolder = os.getcwd(), radius = 20, noOfMoments = 20, leave = True): #radius = 15 & noOfMoment = 10 tested works, noOfMoment = 40 optimal performance
    oldDir = os.getcwd() 
